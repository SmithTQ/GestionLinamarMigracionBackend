...
class CustomerInvitationTest extends TestCase
{
    ...
    public function test_invitation_generates_whatsapp_link_and_can_be_used_once(): void
    {
        ...
        $districtList = DistrictList::create(['branch_id' => $branch->id, 'code' => 'INV-LIST', 'name' => 'Cobertura invitación', 'is_active' => true]);
        $districtList->districts()->attach($district);
        $campaign->districtLists()->attach($districtList);
        $product = Product::create(['branch_id' => $branch->id, 'sku' => 'INV-001', 'name' => 'Producto invitación', 'slug' => 'producto-invitacion', 'base_price' => 10]);
        ...
        $payload = ['submission_key' => 'inv-sub-1', 'product_sku' => 'INV-001', 'sender_name' => 'Cliente Uno', 'sender_phone' => '51987654321', 'recipient_name' => 'Destinatario', 'recipient_phone' => '966554433', 'district_code' => 'LIM-INV', 'address' => 'Av. Test 1', 'delivery_reference' => 'Casa azul frente al parque', 'latitude' => -12.12, 'longitude' => -77.03, 'delivery_time' => '10:00'];
