...
class PublicInvitationDynamicFieldsTest extends TestCase
{
    ...
    public function test_invitation_submission_persists_custom_fields(): void
    {
        ...
        $campaign = Campaign::create(['code' => 'INV-DYNAMIC-CAMP', 'name' => 'Campana invitacion', 'status' => 'open', 'branch_id' => $branch->id]);
        $district = District::create(['code' => 'INV-DYNAMIC-DIST', 'name' => 'Miraflores']);
        $districtList = DistrictList::create(['branch_id' => $branch->id, 'code' => 'INV-DYNAMIC-LIST', 'name' => 'Cobertura invitacion', 'is_active' => true]);
        $districtList->districts()->attach($district);
        $campaign->districtLists()->attach($districtList);
        $product = Product::create(['branch_id' => $branch->id, 'sku' => 'INV-DYNAMIC-001', 'name' => 'Producto invitacion', 'slug' => 'producto-invitacion-dynamic', 'base_price' => 10]);
        ...
        $payload = ['submission_key' => 'inv-dynamic-submission', 'product_sku' => $product->sku, 'sender_name' => 'Cliente', 'sender_phone' => '51999999999', 'recipient_name' => 'Destinatario', 'recipient_phone' => '51988888888', 'district_code' => $district->code, 'latitude' => -12.12, 'longitude' => -77.03, 'delivery_reference' => 'Casa azul frente al parque', 'delivery_time' => '10:00', 'reference' => 'Puerta azul'];
