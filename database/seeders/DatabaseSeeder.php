...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
            ...
            $role->permissions()->sync(
                $slug === 'super_admin'
                    ...
                    : Permission::query()->whereIn('slug', match ($slug) {
                        'campaign_manager' => ['campaigns.view', 'campaigns.manage', 'branches.view', 'orders.view', 'orders.manage', 'imports.create', 'products.view', 'products.manage', 'forms.view', 'forms.manage'],
                        'dispatcher' => ['campaigns.view', 'branches.view', 'orders.view', 'orders.manage', 'routes.manage'],
                        'courier' => ['campaigns.view', 'branches.view', 'orders.view'],
                        default => ['campaigns.view', 'branches.view', 'orders.view'],
                    })->pluck('id')
            );
        }
        ...
        $fields = [
            ...
            ['key'=>'dedication','label'=>'Dedicatoria u observaciones','type'=>'textarea','is_system'=>false,'sort_order'=>110],
        ];
