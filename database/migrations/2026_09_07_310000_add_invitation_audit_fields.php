...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('form_invitations', function (Blueprint $table): void {
            ...
            $table->foreignId('revoked_by_user_id')->nullable()->after('used_at')->constrained('users')->nullOnDelete();
    ...
    public function down(): void
    {
        Schema::table('form_invitations', function (Blueprint $table): void {
            ...
            $table->dropColumn(['created_by_user_id', 'revoked_by_user_id', 'revoked_at']);
        });
    }
};
